\begin{eyenumerate}
   \item \TalkItem{appointee for Adjoint school 2019}{}
   {A webinar and online applied Category Theory reading course.}% Each of the twelve participants composed a blog post for the $n$-Category Caf\'e \url{https://golem.ph.utexas.edu/category/} over the course of the first six months of 2014, which has been published every other week. The other participants commented and interacted together, often creating stimulating discussions.}
   ...
   \item \TalkItem{appointee for Kan Extension Seminar I}{}
